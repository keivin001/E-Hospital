            ...
            {prescriptions.map(rx => (
              <div key={rx.id} className={`card card-hover`} style={{ padding: '20px', cursor: 'pointer', border: selected?.id === rx.id ? '2px solid var(--primary)' : '1px solid var(--gray-200)' }}
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button className="btn btn-ghost btn-sm" onClick={e => { e.stopPropagation(); addToast('Prescription downloaded', 'success'); }}>
        ...
        {selected && (
          <div className="animate-fadeIn">
            <div className="card" style={{ padding: '24px', position: 'sticky', top: '80px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button className="btn btn-ghost btn-sm" style={{ flex: 1 }} onClick={() => addToast('Prescription downloaded', 'success')}>
