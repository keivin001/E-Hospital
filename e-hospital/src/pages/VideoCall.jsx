    ...
    <Layout title="Video Consultation">
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ width: '72px', height: '72px', background: 'var(--primary-light)', borderRadius: 'var(--radius-xl)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <Video size={32} color="var(--primary)" />
          </div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--gray-900)', marginBottom: '8px' }}>Video Consultation</h2>
          <p style={{ color: 'var(--gray-500)' }}>Connect face-to-face with your doctor from anywhere</p>
        </div>

        {/* Features */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
          {[
            { icon: '🔒', title: 'Encrypted', desc: 'End-to-end encrypted video calls' },
            { icon: '📱', title: 'HD Quality', desc: 'Crystal clear HD video and audio' },
            { icon: '💊', title: 'Prescription', desc: 'Get prescriptions after consultation' },
          ].map(f => (
            <div key={f.title} style={{ textAlign: 'center', padding: '20px', background: 'white', borderRadius: 'var(--radius-lg)', border: '1px solid var(--gray-200)' }}>
              <div style={{ fontSize: '2rem', marginBottom: '8px' }}>{f.icon}</div>
              <div style={{ fontWeight: 700, color: 'var(--gray-900)', marginBottom: '4px' }}>{f.title}</div>
              <div style={{ fontSize: '0.8rem', color: 'var(--gray-400)' }}>{f.desc}</div>
            </div>
          ))}
        </div>
        ...
        <div className="card" style={{ padding: '24px' }}>
          <h3 style={{ fontWeight: 700, marginBottom: '16px', color: 'var(--gray-900)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {onlineDoctors.map(doc => (
              <div key={doc.id} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--gray-200)', background: 'var(--gray-50)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '0.8rem', color: 'var(--primary)', fontWeight: 600 }}>{doc.specialty}</div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--gray-400)', marginTop: '2px' }}>{doc.hospital}</div>
                </div>
<<<<<<< HEAD
...
=======
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontWeight: 700, color: 'var(--primary)', marginBottom: '6px' }}>${doc.fee}</div>
                  <button className="btn btn-primary btn-sm" onClick={() => startCall(doc)}>
